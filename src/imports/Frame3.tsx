...
export default function Frame() {
  return (
    <div className="relative size-full">
      <div className="absolute bg-[#00375a] h-[75px] left-0 top-0 w-full" />
      <MobileMenu />
      <div className="absolute flex flex-col font-['Albert_Sans:SemiBold',sans-serif] font-semibold h-[16px] justify-center leading-[0] right-[30px] text-[#d05d49] text-[0px] text-right top-[43px] translate-y-[-50%] w-[132px]">
